...
public record FlightDto(int Id, string Code, string DepartureAirport, string ArrivalAirport, DateTime? DepartureDate, DateTime? ArrivalDate, TimeSpan? Duration, int AircraftModelId);